...
ALLOWED_USER_ID = 5344691638  # Admin user ID
...
# UPI ID for payment
UPI_ID = "badnam.badshah1@ibl"  # Replace with your actual UPI ID
...
async def start(update: Update, context: CallbackContext):
    ...
    if chat_id not in allowed_users:
        message = (
            "*🚫 Access Denied*\n\n"
            ". 💸 𝐏𝐑𝐈𝐂𝐄 𝐋𝐈𝐒𝐓:-  5 𝐇𝐨𝐮𝐫 𝟑𝟎₹ 24 𝐇𝐨𝐮𝐫 𝟖𝟎₹ :\n\n"
            "*🔹 Pay via UPI:*\n"
            f"Pay to: {UPI_ID}\n\n"
            "𝐉𝐀𝐈𝐒𝐄 𝐇𝐈 𝐏𝐀𝐘𝐌𝐄𝐍𝐓 𝐊𝐀𝐑𝐎𝐆𝐄 𝐓𝐎 𝐁𝐀𝐃𝐍𝐀𝐌 𝐁𝐇𝐀𝐈 𝐊𝐎 𝐏𝐀𝐘𝐌𝐄𝐍𝐓 𝐊𝐀 𝐒𝐂𝐑𝐄𝐄𝐍𝐒𝐇𝐎𝐓 𝐒𝐀𝐍𝐃 𝐊𝐑𝐎 ❤‍🔥.\n\nhttps://t.me/DarkDdosHack/98"
        )
    else:
        message = (
    ...
    keyboard = [
        [InlineKeyboardButton("𝐌𝐀𝐒𝐒𝐀𝐆𝐄 𝐁𝐀𝐃𝐍𝐀𝐌", url=f"tg://user?id={ALLOWED_USER_ID}")],
    ]
